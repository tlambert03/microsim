...
sim = ms.Simulation(
    ...
    truth_space=ms.ShapeScaleSpace(shape=(64, 512, 512), scale=(0.064, 0.064, 0.064)),
    ...
    sample=ms.Sample(
        labels=[
            ...
            ms.FluorophoreDistribution(
                distribution=ms.CosemLabel(dataset="jrc_hela-3", label="ne-mem_pred"),
                fluorophore="iRFP702",
            ),
        ]
    ),
    channels=[lib.FITC, lib.TRITC, lib.CY7.model_copy(update={"power": 10})],
